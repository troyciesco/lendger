...
import { provinceCodesCAN } from "../../utils/locationCodes"
...
const CANForm = ({ classes, country }) => {
	...
	const [state, setStateRegion] = useState("QC")
						...
						<form onSubmit={event => handleSubmit(event, createProject)}>
							...
							<FormControl>
								...
								<Select
									...
									value={state}
								>
									{provinceCodesCAN.map(provinceCode => {
										return (
...
export default withStyles(styles)(CANForm)
